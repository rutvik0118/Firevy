...
const blogPostSchema = new mongoose.Schema({
  ...
  brandText: { type: String, default: 'firevy.co' },
  badge: { type: String, default: 'INSIGHT' },
  tag: { type: String, default: '</> TECH' },
  subtext: { type: String, default: 'Next-Gen Engineering Insights' },
  buttonText: { type: String, default: 'Read the full blog' },
