      ...
      <div className="charts-grid">
        ...
        <div className="glass-card chart-card">
          <div className="chart-card-header">
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#ffffff' }}>API Inquiries & Request Velocity</h3>
        ...
        <div className="glass-card chart-card">
          <div className="chart-card-header">
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#ffffff' }}>Client Sectors</h3>
              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1.8fr', gap: '1.25rem', marginBottom: '2rem' }}>
        ...
        <div className="glass-card" style={{ padding: '1.25rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#ffffff' }}>Technology Registry</h3>
              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
        ...
        <div className="glass-card" style={{ padding: '1.25rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
            <div>
              <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#ffffff' }}>Recent Enterprise Leads</h3>
              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
