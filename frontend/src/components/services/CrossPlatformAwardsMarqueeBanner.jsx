...
export const CrossPlatformAwardsMarqueeBanner = () => {
  ...
  // 2. AUTO-SCROLLING BADGES (Rotating Marquee track matching screenshot 1:1)
  const rotatingBadges = [
    // 2.1 Red Ribbon - Most Reviewed Software Developers
    {
      id: 'most-reviewed-devs',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 115" className="w-full h-full drop-shadow-md">
            ...
            <text x="50" y="44" textAnchor="middle" fill="#991B1B" fontSize="6.2" fontWeight="900" fontFamily="sans-serif">SOFTWARE</text>
            <text x="50" y="52" textAnchor="middle" fill="#111827" fontSize="5.2" fontWeight="800" fontFamily="sans-serif">DEVELOPERS</text>
    ...
    // 2.2 GoodFirms Blue Scalloped Badge
    {
      id: 'goodfirms-blue',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-18 sm:h-20 md:h-22 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md">
            ...
            <text x="50" y="68" textAnchor="middle" fill="#FFFFFF" fontSize="5.5" fontWeight="900">TOP DEDICATED SOFTWARE</text>
    ...
    // 2.3 Red Ribbon - Most Reviewed Dedicated Software Development Company
    {
      id: 'most-reviewed-dedicated-company',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 115" className="w-full h-full drop-shadow-md">
            <path d="M 12 10 L 88 10 L 88 95 L 50 112 L 12 95 Z" fill="#FFFFFF" stroke="#991B1B" strokeWidth="2" />
            ...
            <text x="50" y="44" textAnchor="middle" fill="#991B1B" fontSize="5.5" fontWeight="900">DEDICATED SOFTWARE</text>
            <text x="50" y="51" textAnchor="middle" fill="#111827" fontSize="4.6" fontWeight="800">DEVELOPMENT COMPANY</text>
            
            <g fill="#B91C1C">
              <polygon points="50,62 51.5,65 55,65 52,67 53,70 50,68 47,70 48,67 45,65 48.5,65" />
            </g>
    ...
    // 2.4 Clutch Hexagon Badge - Top Dedicated Software Company 2022
    {
      id: 'clutch-hexagon',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 110" className="w-full h-full drop-shadow-md">
            ...
            <text x="50" y="25" textAnchor="middle" fill="#64748B" fontSize="5" fontWeight="800">TOP DEDICATED</text>
            <text x="50" y="32" textAnchor="middle" fill="#1E293B" fontSize="5.2" fontWeight="900">SOFTWARE COMPANY</text>
    ...
    // 2.5 Red Ribbon - Dedicated Software Development Companies
    {
      id: 'most-reviewed-dedicated-companies',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 115" className="w-full h-full drop-shadow-md">
            <path d="M 12 10 L 88 10 L 88 95 L 50 112 L 12 95 Z" fill="#FFFFFF" stroke="#991B1B" strokeWidth="2" />
            ...
            <text x="50" y="44" textAnchor="middle" fill="#991B1B" fontSize="5.2" fontWeight="900">DEDICATED</text>
            <text x="50" y="50" textAnchor="middle" fill="#111827" fontSize="4.2" fontWeight="800">SOFTWARE DEVELOPMENT</text>
            <text x="50" y="56" textAnchor="middle" fill="#991B1B" fontSize="5" fontWeight="900">COMPANIES</text>
  ...
  return (
    <section className="w-full bg-[#005F96] text-white py-4 sm:py-5 border-y border-blue-900/30 overflow-hidden select-none font-sans text-left">
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-8">
          
          {/* Left Block: Heading + FIXED TROPHY BADGE (Never scrolls, stays fixed in place) */}
          <div className="flex items-center space-x-4 sm:space-x-6 shrink-0">
            <h3 className="text-lg sm:text-xl lg:text-[22px] font-[800] tracking-tight text-white leading-[1.2] max-w-xs sm:max-w-sm text-left">
              World Wide Top Rated IT<br />
              Company on Clutch
            </h3>
...
export default CrossPlatformAwardsMarqueeBanner;
