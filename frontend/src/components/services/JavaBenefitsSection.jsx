...
const benefitsData = [
  {
    ...
    desc: "Java's 'Write Once, Run Anywhere' (WORA) philosophy guarantees reliable execution across any cloud, OS, or container infrastructure.",
    icon: (
  ...
  },
  {
    ...
    desc: 'Advanced built-in type safety, automatic memory management, bytecode verification, and enterprise cryptographic libraries protect your data.',
    icon: (
      <svg viewBox="0 0 48 48" className="w-11 h-11 text-[#005F96]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        {/* Laptop Screen */}
  ...
  },
  {
    ...
    desc: 'Leverage modern JVM multi-threading, virtual threads (Project Loom), and optimized memory caching to handle millions of transactions per second.',
    icon: (
      <svg viewBox="0 0 48 48" className="w-11 h-11 text-[#005F96]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        {/* 3 Rising Graph Bars */}
  ...
  {
    id: 4,
    title: 'Rich Ecosystem & Frameworks',
    desc: 'Access powerful mature libraries like Spring Boot, Hibernate, Quarkus, Micronaut, and Apache Kafka for lightning-fast feature delivery.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Reusable enterprise architectural templates, Spring auto-configuration, and CI/CD pipelines significantly shorten your product release cycles.',
    icon: (
      <svg viewBox="0 0 48 48" className="w-11 h-11 text-[#005F96]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    id: 6,
    title: 'Cost-Effective Long-Term ROI',
    desc: 'Battle-tested backward compatibility and huge global developer talent pool ensure low total cost of ownership over decades.',
    icon: (
      <svg viewBox="0 0 48 48" className="w-11 h-11 text-[#005F96]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        {/* Smartphone Frame */}
...
export const JavaBenefitsSection = () => {
  return (
      ...
      <Container className="max-w-7xl">
        ...
        <div className="text-center max-w-4xl mx-auto mb-7 sm:mb-9 space-y-2">
          ...
          <p className="text-[13.5px] sm:text-[15px] text-[#475569] leading-relaxed max-w-3xl mx-auto font-normal">
            We provide bespoke, robust and scalable Java enterprise solutions that delight users and power Fortune 500 workflows.
          </p>
        </div>
...
export default JavaBenefitsSection;
