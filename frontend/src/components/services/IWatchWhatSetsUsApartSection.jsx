...
const TransparencyIcon = () => (
  <svg className="w-8 h-8 sm:w-9 sm:h-9 text-slate-800" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <defs>
      <clipPath id="hatchClipCircleIWatch">
    ...
    <g clipPath="url(#hatchClipCircleIWatch)">
      <circle cx="29" cy="24" r="12" />
...
export const IWatchWhatSetsUsApartSection = () => {
  ...
  return (
    <section className="pt-10 pb-12 sm:pt-14 sm:pb-16 bg-[#F8FAFC] text-slate-900 text-left font-sans">
      {/* Centered Section Header */}
      <div className="text-center w-full max-w-4xl px-4 sm:px-6 mx-auto mb-9 sm:mb-11 space-y-3">
        <h2
          className="font-[800] text-[#0B0F19] tracking-tight leading-tight"
          style={{ fontSize: '32px' }}
        >
          What Sets Us Apart As Iwatch App Development Company?
        </h2>
      ...
      <Container className="max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mx-auto">
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div 
              className="absolute -top-2.5 -left-2.5 w-0 h-0 border-t-[28px] border-t-[#005F96] border-r-[28px] border-r-transparent z-20 pointer-events-none drop-shadow-sm" 
            />
            {/* Bottom-Right Triangle Accent */}
            <div 
              className="absolute -bottom-2.5 -right-2.5 w-0 h-0 border-b-[28px] border-b-[#005F96] border-l-[28px] border-l-transparent z-20 pointer-events-none drop-shadow-sm" 
            />
            ...
            <div className="relative z-10 bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-xl font-sans">
              ...
              {submitted ? (
                <div className="p-6 rounded-xl bg-emerald-50 text-emerald-800 text-center space-y-2 border border-emerald-200 font-sans">
                  ...
                  <p className="text-xs sm:text-sm">Your inquiry has been submitted successfully. Our iWatch development specialists will reach out to you shortly.</p>
                  <button 
                    onClick={() => setSubmitted(false)}
                    className="mt-3 px-4 py-2 bg-[#005F96] text-white text-xs font-bold rounded-lg cursor-pointer"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4 font-sans text-left">
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="px-3.5 py-3 rounded-lg bg-slate-50 border border-slate-200 text-xs font-bold text-slate-700 shrink-0 font-sans select-none">
                      +1 ▾
                    </div>
                    <input
                      type="tel"
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 rounded-lg bg-[#005F96] hover:bg-[#004B77] text-white text-sm font-extrabold shadow-md hover:shadow-lg transition-all duration-200 font-sans tracking-wide cursor-pointer"
                  >
                    Send
                  </button>
                </form>
...
export default IWatchWhatSetsUsApartSection;
