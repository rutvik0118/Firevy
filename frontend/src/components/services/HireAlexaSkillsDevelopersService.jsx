              ...
              {[
                {
                  id: 1,
                  category: 'Trending',
                  title: 'Voice AI & Alexa Skill Team',
                  image: 'https://images.unsplash.com/photo-1616469829941-c7200edec809?w=800&auto=format&fit=crop&q=80',
                  techs: ['ASK SDK', 'AWS Lambda', 'Node.js', 'SSML', 'APL'],
                  composition: ['1 Voice Architect', '3 Alexa Developers', '1 VUI Designer', '1 QA Specialist'],
                  summary: 'Specialized voice engineering squad building custom Alexa skills and multimodal screen experiences.'
                },
                {
                  id: 2,
                  category: 'Product Development',
                  title: 'Smart Home & IoT Skill Squad',
                  image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&auto=format&fit=crop&q=80',
                  techs: ['Smart Home API', 'MQTT', 'AWS IoT', 'Python', 'DynamoDB'],
                  composition: ['1 IoT Lead', '3 Backend Engineers', '1 Smart Home Adapter Specialist'],
                  summary: 'Dedicated IoT voice squad integrating smart home devices with Alexa voice control.'
                },
                {
                  id: 3,
                  category: 'Trending',
                  title: 'Voice Commerce & In-Skill Team',
                  image: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=800&auto=format&fit=crop&q=80',
                  techs: ['In-Skill Purchasing', 'OAuth 2.0', 'Account Linking', 'Stripe'],
                  composition: ['1 Solution Architect', '3 Senior Alexa Engineers', '1 Security Specialist'],
                  summary: 'Expert voice commerce developers creating monetized Alexa skills and subscription flows.'
                }
              ].map((team) => {
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mb-4">
                        ...
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer ${
                            currentTab === 'composition' ? 'bg-[#006095] text-white shadow-xs' : 'bg-white text-slate-200/60'
                          }`}
                        >
                          Team Composition
                        </button>
