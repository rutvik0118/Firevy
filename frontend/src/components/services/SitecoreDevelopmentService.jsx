      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
              Our Sitecore Technology Stack
            </h2>
            <p className="text-slate-600 text-base">
              A comprehensive toolchain engineered for enterprise reliability, high concurrency, and seamless omnichannel delivery.
            </p>
          </div>

          <div className="flex justify-center gap-2 mb-10 overflow-x-auto pb-2">
            {[
              { id: 'cms', label: 'Sitecore Ecosystem' },
              { id: 'languages', label: 'Languages & Headless' },
