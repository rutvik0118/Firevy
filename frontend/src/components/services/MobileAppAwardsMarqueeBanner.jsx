...
export const MobileAppAwardsMarqueeBanner = () => {
  ...
  const rotatingBadges = [
    // 2.1 Red Ribbon - Most Reviewed Top Mobile App Development Company
    {
      id: 'most-reviewed-mobile-1',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 115" className="w-full h-full drop-shadow-md">
            ...
            <text x="50" y="44" textAnchor="middle" fill="#991B1B" fontSize="6" fontWeight="900" fontFamily="sans-serif">TOP MOBILE APP</text>
    ...
    // 2.5 Red Ribbon - Most Reviewed App Development Company India
    {
      id: 'most-reviewed-app-india',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 115" className="w-full h-full drop-shadow-md">
            <path d="M 12 10 L 88 10 L 88 95 L 50 112 L 12 95 Z" fill="#FFFFFF" stroke="#991B1B" strokeWidth="2" />
            ...
            <text x="50" y="44" textAnchor="middle" fill="#991B1B" fontSize="5.8" fontWeight="900">APP DEVELOPMENT</text>
            <text x="50" y="52" textAnchor="middle" fill="#111827" fontSize="5" fontWeight="800">INDIA</text>
    ...
    // 2.6 Red Ribbon - Most Reviewed Mobile & Enterprise App
    {
      id: 'most-reviewed-enterprise-app',
      content: (
        <div className="w-18 sm:w-20 md:w-22 h-20 sm:h-22 md:h-24 flex items-center justify-center shrink-0">
          <svg viewBox="0 0 100 115" className="w-full h-full drop-shadow-md">
            <path d="M 12 10 L 88 10 L 88 95 L 50 112 L 12 95 Z" fill="#FFFFFF" stroke="#991B1B" strokeWidth="2" />
            ...
            <text x="50" y="44" textAnchor="middle" fill="#991B1B" fontSize="5.8" fontWeight="900">MOBILE &</text>
            <text x="50" y="52" textAnchor="middle" fill="#111827" fontSize="4.6" fontWeight="800">ENTERPRISE APP</text>
  ...
  return (
    <section className="w-full bg-[#005F96] text-white py-5 sm:py-6 border-y border-blue-900/30 overflow-hidden select-none font-sans text-left">
...
export default MobileAppAwardsMarqueeBanner;
