...
const techStackCards = [
  {
    ...
    col1: ['Java 21 LTS', 'Spring Boot', 'Hibernate / JPA'],
    col2: ['Quarkus', 'Micronaut', 'Spring Cloud']
  },
  {
    id: 2,
    title: 'Frontend',
    ...
    col1: ['React JS', 'Angular', 'Vue.js'],
    col2: ['Thymeleaf', 'Next.js', 'Tailwind CSS']
  },
  {
    id: 3,
    title: 'Database',
    ...
    col1: ['PostgreSQL', 'Oracle DB', 'MySQL'],
    col2: ['MongoDB', 'Redis Caching', 'Cassandra']
  },
  {
    id: 4,
    ...
    col1: ['AWS Cloud', 'Docker', 'Kubernetes'],
    col2: ['Google Cloud', 'Microsoft Azure', 'GitHub Actions']
  },
  {
    id: 5,
    ...
    col1: ['JUnit 5', 'Mockito', 'Selenium'],
    col2: ['Apache JMeter', 'SonarQube', 'Postman']
  },
  {
    id: 6,
    ...
    col1: ['Microservices', 'Apache Kafka', 'RESTful APIs'],
    col2: ['GraphQL', 'Event-Driven Arch']
  }
];

export const JavaTechStackSection = () => {
  return (
...
export default JavaTechStackSection;
