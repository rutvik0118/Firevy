...
export const ConversionCalloutBanner = ({ data }) => {
  const title = data?.title || 'Let’s Start Something Together';
  ...
  const leftImg = data?.leftImage || 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=600&q=80';
  const rightImg = data?.rightImage || 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=600&q=80';
