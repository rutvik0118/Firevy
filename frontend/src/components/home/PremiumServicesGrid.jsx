...
export const PremiumServicesGrid = ({ data, title, subtitle, companyName = "Firevy" }) => {
  ...
  return (
    <section className="py-16 sm:py-20 bg-[#005F96] text-white relative font-sans overflow-hidden">
      <Container>
        {/* Section Header */}
        <motion.div
          ...
          {services.map((item, idx) => (
            <motion.div key={idx} variants={cardVariants}>
              ...
              >
                ...
                {/* Service Title */}
                <span className="text-[13px] sm:text-[14px] font-[800] text-slate-900 font-sans leading-snug group-hover:text-[#005F96] transition-colors">
