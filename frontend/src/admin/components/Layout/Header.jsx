...
import { Menu, Bell, RefreshCw, ExternalLink, LogOut } from 'lucide-react';
      ...
      <div className="header-right-tools">
          ...
          {showNotifications && (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                <h4 style={{ fontSize: '0.875rem', fontWeight: 700, color: 'var(--text-primary)' }}>System Activity</h4>
                <span style={{ fontSize: '0.75rem', color: 'var(--primary)', cursor: 'pointer', fontWeight: 600 }} onClick={() => setLogs([])}>
                  Clear
                </span>
              </div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            ...
            <span style={{ fontSize: '0.8125rem', fontWeight: 600, color: 'var(--text-primary)' }}>{user?.name || 'Admin'}</span>
          </button>
          ...
          {showUserMenu && (
            ...
            >
              ...
              <button
                ...
                style={{ width: '100%', justifyContent: 'flex-start', color: '#DC2626', marginTop: '0.375rem', gap: '0.5rem' }}
              >
                <LogOut size={14} />
                <span>Logout</span>
              </button>
